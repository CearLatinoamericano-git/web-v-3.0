    ...
    <section className={styles.heroSection}>
      ...
      <div className={styles.contentContainer}>
        ...
        <div className={styles.badgeContainer}>
          <div className={isTaller ? styles.badgeTaller : styles.badge}>
            <p className={styles.badgeText}>
              {isTaller ? 'Taller' : type === 'diplomado' ? 'Diplomado' : 'Curso'}
            </p>
          </div>
        </div>
        ...
        <div className={styles.statsContainer}>
          <div className={isTaller ? styles.statsGridTaller : styles.statsGrid}>

            {/* Certification */}
            <div className={styles.statItem}>
              <div className={styles.statIconContainer}>
                <div className={styles.statIcon}>
                  <svg fill="none" preserveAspectRatio="none" viewBox="0 0 31.5 31.5">
                    <g>
            ...
            <div className={styles.statItem}>
              ...
              <div className={styles.statContent}>
                ...
                <p className={`${styles.statValue} ${styles.statValueCapitalize}`}>
                  {stats.modality}
                </p>
              </div>
            </div>
        ...
        <div className={styles.buttonsContainer}>
          ...
          <button
            onClick={onEnroll}
            className={isTaller ? styles.enrollButtonTaller : styles.enrollButton}
          >
          ...
          {onBrochure && (
            <button
              onClick={onBrochure}
              className={isTaller ? styles.brochureButtonTaller : styles.brochureButton}
            >
              <div className={styles.brochureButtonIcon}>
                <svg fill="none" preserveAspectRatio="none" viewBox="0 0 22.5 22.5">
                  <g>
          ...
          {onContactAdvisor && (
            <button
              ...
              className={isTaller ? styles.contactButtonTaller : styles.contactButton}
            >
              <div className={styles.contactButtonIcon}>
                <svg fill="none" preserveAspectRatio="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
