import svgPaths from "./svg-pa67alnyn9";
  ...
  return (
    <div className="bg-[#1c98b7] h-[25px] relative rounded-[33554400px] shadow-[0px_0px_25px_0px_rgba(0,0,0,0.2)] shrink-0 w-full" data-name="Text">
      <div className="content-stretch flex items-start px-[13.5px] py-[4.5px] relative size-full">
        <p className="flex-[1_0_0] font-['Inter:Bold',sans-serif] font-bold leading-[18px] min-h-px min-w-px not-italic relative text-[13.5px] text-center text-white whitespace-pre-wrap">Cursos</p>
      </div>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="relative shrink-0 w-full">
      <div className="content-stretch flex items-start pr-[10px] relative w-full">
        <p className="flex-[1_0_0] font-['Bricolage_Grotesque:Regular',sans-serif] font-normal h-[24px] leading-[24.75px] min-h-px min-w-px relative text-[#6e6e6e] text-[20px] whitespace-pre-wrap" style={{ fontVariationSettings: "'opsz' 14, 'wdth' 100" }}>
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-h-px min-w-px relative w-full">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold h-full leading-[29px] not-italic relative shrink-0 text-[#1c98b7] text-[30px] w-[396px] whitespace-pre-wrap">Junta de Prevención y Resolución de Disputas</p>
    </div>
  );
}
  ...
  return (
    <div className="flex-[1_0_0] h-[25.692px] min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[7px] items-start overflow-clip relative rounded-[inherit] size-full">
        <div className="h-[22.857px] relative shrink-0 w-[20px]" data-name="Vector">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 22.8571">
            <path d={svgPaths.p266f1500} fill="var(--fill-0, #1C98B7)" id="Vector" />
          </svg>
        </div>
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[25.714px] not-italic relative shrink-0 text-[#4b5563] text-[19.286px]">19/02/26 - 13/04/26</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[30.696px] not-italic relative shrink-0 text-[#4b5563] text-[21.487px]">Doble certificación</p>
      </div>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="content-stretch flex gap-[9px] items-center relative shrink-0 w-full" data-name="Container">
      <div className="h-[20.463px] relative shrink-0 w-[12.279px]" data-name="Vector">
        <div className="absolute inset-[-5%_-8.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.325 22.5098">
            <path d={svgPaths.p204cb000} id="Vector" stroke="var(--stroke-0, #1C98B7)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.04643" />
          </svg>
        </div>
      </div>
  ...
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28.608px] not-italic relative shrink-0 text-[#1cb8a4] text-[20.026px] w-[221.238px] whitespace-pre-wrap">384 horas académicas</p>
      </div>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="content-stretch flex gap-[5px] h-[20.197px] items-center relative shrink-0 w-[429px]" data-name="Container">
      <div className="h-[17.165px] relative shrink-0 w-[19.072px]" data-name="Vector">
        <div className="absolute inset-[-5.56%_-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20.9795 19.0722">
            <path d={svgPaths.p151628c0} id="Vector" stroke="var(--stroke-0, #1CB8A4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.90723" />
          </svg>
        </div>
      </div>
      <Text3 />
...
function TarjetasDeCursos() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[20px] h-[506px] items-start overflow-clip relative rounded-tl-[20px] rounded-tr-[20px] shrink-0 w-[432px]" data-name="Tarjetas de Cursos">
      <Cursos />
      <Frame2 />
      <Frame8 />
    </div>
...
function Container3() {
  return (
    <div className="h-[22.5px] relative shrink-0 w-[108.516px]" data-name="Container">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24.75px] left-0 not-italic text-[20px] text-white top-[-1px]">Inversión</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[23px] relative shrink-0 w-[76px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[24.75px] left-0 not-italic text-[20px] text-white top-[-1px]">Ver más</p>
      </div>
    </div>
  );
}
    ...
    <div className="mb-[-10px] relative shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center p-[10px] relative w-full">
          <p className="font-['Inter:Bold',sans-serif] font-bold leading-[36px] not-italic relative shrink-0 text-[41px] text-white">S/ 4,200</p>
        </div>
      </div>
    </div>
  );
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-col items-start pb-[17px] pt-[7px] relative shrink-0 w-[367.484px]">
      <Frame9 />
      <Frame10 />
    </div>
  );
...
export default function Frame12() {
  return (
    <div className="bg-[#1c98b7] content-stretch flex flex-col gap-[10px] items-center relative rounded-[20px] shadow-[0px_4px_7px_0px_rgba(0,0,0,0.33)] size-full">
      <TarjetasDeCursos />
      <Frame11 />
    </div>
  );
