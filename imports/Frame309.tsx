import svgPaths from "./svg-nygc8qopmd";
  ...
  return (
    <div className="h-[22.857px] relative shrink-0 w-[20px]" data-name="fa-regular:calendar-alt">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 22.8571">
        <g clipPath="url(#clip0_9012_100)" id="fa-regular:calendar-alt">
          <path d={svgPaths.p124d6a70} fill="var(--fill-0, #1C98B7)" id="Vector" />
        </g>
        <defs>
          <clipPath id="clip0_9012_100">
  ...
  return (
    <div className="relative shrink-0 size-[22.887px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22.8867 22.8867">
        <g id="Icon">
          <path d="M11.4431 6.67539V20.026" id="Vector" stroke="var(--stroke-0, #1CB8A4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.90723" />
          <path d={svgPaths.pebf7640} id="Vector_2" stroke="var(--stroke-0, #1CB8A4)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.90723" />
        </g>
      </svg>
    </div>
  );
