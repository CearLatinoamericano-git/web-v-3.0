import svgPaths from "./svg-pp4ou9s5l7";
...
function Group() {
  return (
    <div className="absolute contents left-0 top-0">
      ...
      <div className="absolute h-[744px] left-0 top-0 w-[895px]" data-name="IMG_746522 2">
...
export default function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start px-[69px] py-[46px] relative size-full">
      <Group />
