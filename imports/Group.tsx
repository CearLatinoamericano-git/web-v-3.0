import svgPaths from "./svg-lf973w7pwi";

export default function Group() {
  return (
    <div className="relative size-full" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 102.383 60.5372">
        <g clipPath="url(#clip0_2844_608)" id="Group">
        ...
        <defs>
          <clipPath id="clip0_2844_608">
            <rect fill="white" height="60.5372" width="102.383" />
          </clipPath>
        </defs>
      </svg>
    </div>
