import svgPaths from "./svg-wf6fx5t5wa";
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="content-stretch flex items-start pr-[10px] relative w-full">
        <p className="flex-[1_0_0] font-['Bricolage_Grotesque:SemiBold',sans-serif] font-semibold h-[24px] leading-[24.75px] min-h-px min-w-px relative text-[20px] text-black whitespace-pre-wrap" style={{ fontVariationSettings: "'opsz' 14, 'wdth' 100" }}>
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-h-px min-w-px relative w-full">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold h-full leading-[34px] not-italic relative shrink-0 text-[#1c98b7] text-[30px] w-[396px] whitespace-pre-wrap">Junta de Prevención y Resolución de Disputas</p>
    </div>
  );
}
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[7px] items-start overflow-clip relative rounded-[inherit] size-full">
        <div className="h-[22.857px] relative shrink-0 w-[20px]" data-name="Vector">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 22.8571">
            <path d={svgPaths.p266f1500} fill="var(--fill-0, #1E397E)" id="Vector" />
          </svg>
        </div>
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[25.714px] not-italic relative shrink-0 text-[#1e397e] text-[19.286px]">19/02/26 - 13/04/26</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30.696px] not-italic relative shrink-0 text-[#1e397e] text-[21.487px]">Doble certificación</p>
      </div>
    </div>
  );
}
      ...
      <div className="h-[20.463px] relative shrink-0 w-[12.279px]" data-name="Vector">
        <div className="absolute inset-[-5%_-8.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14.325 22.5098">
            <path d={svgPaths.p204cb000} id="Vector" stroke="var(--stroke-0, #1E397E)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.04643" />
          </svg>
        </div>
      </div>
  ...
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28.608px] not-italic relative shrink-0 text-[#0f2c76] text-[20.026px] w-[221.238px] whitespace-pre-wrap">384 horas académicas</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[5px] h-[20.197px] items-center relative shrink-0 w-[429px]" data-name="Container">
      <div className="h-[17.165px] relative shrink-0 w-[19.072px]" data-name="Vector">
        <div className="absolute inset-[-5.83%_-5.24%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.0723 19.165">
            <path d={svgPaths.p3baa1ba0} id="Vector" stroke="var(--stroke-0, #074A97)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </svg>
        </div>
      </div>
      <Text3 />
