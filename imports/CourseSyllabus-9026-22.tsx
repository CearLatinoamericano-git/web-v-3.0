...
function Frame() {
  return (
    <div className="bg-[#ee8a28] content-stretch flex items-center justify-center p-[11.891px] relative rounded-[10.702px] shrink-0 w-[460.175px]">
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[35.789px] items-start relative shrink-0 w-[712.261px]">
      <Frame3 />
      <Frame />
      <p className="font-['Inter:Regular',sans-serif] font-normal h-[265.263px] leading-[30.433px] not-italic relative shrink-0 text-[18.728px] text-[rgba(0,0,0,0.95)] text-justify w-[712.632px] whitespace-pre-wrap">Abogado y especialista con más de 18 años de trayectoria profesional. Ha ocupado cargos estratégicos en entidades destacadas y cuenta con amplia experiencia en arbitraje nacional e internacional, participando en más de 600 arbitrajes como presidente de tribunal arbitral, árbitro único e integrante de tribunales arbitrales. Actualmente es árbitro del Registro Nacional de Árbitros (RNA), consultor especializado y docente.</p>
    </div>
  );
}
    ...
    <div className="absolute content-stretch flex gap-[59px] items-end left-[238px] top-[80px]">
      <div className="h-[574.327px] relative rounded-[234.158px] shrink-0 w-[405.478px]" data-name="janeyri boyer 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[234.158px]">
          <img alt="" className="absolute h-[97.74%] left-[-23.74%] max-w-none top-[2.19%] w-[138.44%]" src={imgJaneyriBoyer1} />
        </div>
      </div>
      <Frame4 />
    </div>
